...
- 表示モード: `原文`、`翻訳`、`対比表示`
- 対応表: [references/catalog.json](references/catalog.json) と [references/bilingual-map.md](references/bilingual-map.md)
- 残タスク: [references/todo.md](references/todo.md)

段落単位の対比表示に追加修正が必要なページは `todo.md` で管理します。
...
- ASVS 項目、公式 URL、ローカルファイルの対応表: [references/](references/)
...
5. `references/source-map.md`、`references/bilingual-map.md`、`references/catalog.json` の対応情報を必要に応じて更新します。
