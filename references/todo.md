...
- [x] Pilot 対訳ページの `docs/bilingual/csrf-prevention.md`、`docs/bilingual/bean-validation.md`、`docs/bilingual/cryptographic-storage.md` を公式原文全文に対応する段落ペアへ拡張する。完了: 2026-05-21, 残タスク対象ページを全文対訳へ拡張済み。
- [x] Pilot 確認後、`references/bilingual-map.md` に対象を追加しながら、残りの Cheat Sheet へ `docs/bilingual/` 対訳ページを展開する。完了: 2026-05-21, todo記載の残ページを Full 対訳として展開済み。
...
- [x] [docs/translations/csrf-prevention.md](../docs/translations/csrf-prevention.md): 完了: 2026-05-21, 公式原文と照合し全文訳と公開対訳ページへ拡張。
...
- [x] [docs/translations/xss-filter-evasion.md](../docs/translations/xss-filter-evasion.md): 完了: 2026-05-21, 公式原文と照合し全文訳と公開対訳ページへ拡張。
...
- [x] [docs/translations/logging-vocabulary.md](../docs/translations/logging-vocabulary.md): 完了: 2026-05-21, 公式原文と照合し全文訳と公開対訳ページへ拡張。
...
- [x] [docs/translations/session-management.md](../docs/translations/session-management.md): 完了: 2026-05-21, 公式原文と照合し全文訳と公開対訳ページへ拡張。
- [x] [docs/translations/authorization-testing-automation.md](../docs/translations/authorization-testing-automation.md): 完了: 2026-05-21, 公式原文と照合し全文訳と公開対訳ページへ拡張。
