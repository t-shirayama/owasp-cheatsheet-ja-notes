...
| --- | --- | --- |
| 1つの Cheat Sheet の翻訳・英日対訳ページ更新 | 対象 Cheat Sheet 単位 | `docs: expand password storage translation` |
...
| 状態 | 意味 |
| --- | --- |
| 作成済み | ASVS Index coverage として翻訳ファイルと公開用の英日対訳ページが存在する。 |
| 詳細化済み | 原文を確認し、翻訳と英日対訳ページを全文 coverage に近づけて拡張済み。 |
