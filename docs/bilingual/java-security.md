...
<div className="tabbedContent">
  ...
  <input className="tabInput" type="radio" name="java-security-view" id="java-security-summary" />
  <input className="tabInput" type="radio" name="java-security-view" id="java-security-checklist" />
  <input className="tabInput" type="radio" name="java-security-view" id="java-security-bilingual" />

  <div className="contentTabs">
    <label htmlFor="java-security-original">原本</label>
    <label htmlFor="java-security-translation">翻訳</label>
    <label htmlFor="java-security-summary">要点</label>
    <label htmlFor="java-security-checklist">チェックリスト</label>
    <label htmlFor="java-security-bilingual">対比表示</label>
  </div>
...
<section id="java-security-summary-panel" className="tabPanel summaryPanel contentPanel">
...
<section id="java-security-checklist-panel" className="tabPanel checklistPanel contentPanel">

- [ ] 危険なJava API利用をレビューする。
- [ ] XML外部エンティティを無効化する。
- [ ] 安全な暗号ライブラリを使う。
- [ ] 例外で内部情報を返さない。
- [ ] 依存関係スキャンを実施する。
