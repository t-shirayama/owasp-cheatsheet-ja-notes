...
<div className="docHero" data-category="asvs-v1">
  <h1>Java Security Cheat Sheet</h1>
  <p className="docSubtitle">Java セキュリティチートシート</p>
...
- 公式ページ: [Java Security Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Java_Security_Cheat_Sheet.html)
- ASVS 対応: V1.2
