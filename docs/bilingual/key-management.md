...
<p className="docLead">鍵管理チートシートを、原文・翻訳・対比表示で確認できます。ASVS Index 対応の文脈で、公式原文と日本語訳を確認しやすく整理しています。</p>
...
<section id="key-management-bilingual-panel" className="tabPanel bilingualPanel">
