...
<p className="docLead">Third Party Javascript Management Cheat Sheet を、原文・翻訳・対比表示で確認できます。これは OWASP 公式翻訳ではなく、ASVS Index 対応の文脈で公式原文と日本語訳を確認しやすく整理した非公式ページです。</p>
...
<section id="third-party-javascript-management-bilingual-panel" className="tabPanel bilingualPanel contentPanel">
