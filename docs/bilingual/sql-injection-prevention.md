...
<div className="tabbedContent">
  ...
  <input className="tabInput" type="radio" name="sql-injection-prevention-view" id="sql-injection-prevention-summary" />
  <input className="tabInput" type="radio" name="sql-injection-prevention-view" id="sql-injection-prevention-checklist" />
  <input className="tabInput" type="radio" name="sql-injection-prevention-view" id="sql-injection-prevention-bilingual" />

  <div className="contentTabs">
    <label htmlFor="sql-injection-prevention-original">原本</label>
    <label htmlFor="sql-injection-prevention-translation">翻訳</label>
    <label htmlFor="sql-injection-prevention-summary">要点</label>
    <label htmlFor="sql-injection-prevention-checklist">チェックリスト</label>
    <label htmlFor="sql-injection-prevention-bilingual">対比表示</label>
  </div>
...
<section id="sql-injection-prevention-summary-panel" className="tabPanel summaryPanel contentPanel">
...
<section id="sql-injection-prevention-checklist-panel" className="tabPanel checklistPanel contentPanel">
