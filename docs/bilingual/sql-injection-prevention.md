...
<div className="docHero" data-category="asvs-v1">
  <h1>SQL Injection Prevention Cheat Sheet</h1>
  <p className="docSubtitle">SQL インジェクション防止チートシート</p>
...
- 公式ページ: [SQL Injection Prevention Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/SQL_Injection_Prevention_Cheat_Sheet.html)
- ASVS 対応: V1.2
