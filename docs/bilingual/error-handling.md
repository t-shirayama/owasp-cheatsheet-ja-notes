...
<div className="tabbedContent">
  ...
  <input className="tabInput" type="radio" name="error-handling-view" id="error-handling-translation" defaultChecked />
  <input className="tabInput" type="radio" name="error-handling-view" id="error-handling-bilingual" />

  <div className="contentTabs">
    <label htmlFor="error-handling-original" title="OWASP 原文">原文</label>
    <label htmlFor="error-handling-translation" title="日本語訳">翻訳</label>
    <label htmlFor="error-handling-bilingual" title="原文と翻訳を並べて確認">対比表示</label>
  </div>

<section id="error-handling-original-panel" className="tabPanel originalPanel contentPanel">
...
<section id="error-handling-translation-panel" className="tabPanel translationPanel contentPanel">
...
<section id="error-handling-bilingual-panel" className="tabPanel bilingualPanel">
