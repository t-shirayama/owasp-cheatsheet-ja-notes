...
<div className="docHero" data-category="asvs-v1">
  <h1>DOM based XSS Prevention Cheat Sheet</h1>
  <p className="docSubtitle">DOM based XSS 防止チートシート</p>
...
- 公式ページ: [DOM based XSS Prevention Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html)
- ASVS 対応: V1.2, V1.3
