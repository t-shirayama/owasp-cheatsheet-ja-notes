...
<div className="tabbedContent">
  ...
  <div className="contentTabs">
    <label htmlFor="deserialization-original">原本</label>
    <label htmlFor="deserialization-translation">翻訳</label>
    <label htmlFor="deserialization-summary">要点</label>
    <label htmlFor="deserialization-checklist">チェックリスト</label>
    <label htmlFor="deserialization-bilingual">対比表示</label>
  </div>
