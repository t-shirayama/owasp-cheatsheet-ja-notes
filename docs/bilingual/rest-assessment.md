...
<div className="docHero" data-category="asvs-v4">
  <h1>REST Assessment Cheat Sheet</h1>
  <p className="docSubtitle">REST 評価チートシート</p>
...
- 公式ページ: [REST Assessment Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/REST_Assessment_Cheat_Sheet.html)
- ASVS 対応: V4.1
