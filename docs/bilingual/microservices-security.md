...
<div className="docHero" data-category="asvs-v11">
  <h1>Microservices Security Cheat Sheet</h1>
  <p className="docSubtitle">マイクロサービスセキュリティチートシート</p>
...
- 公式ページ: [Microservices Security Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Microservices_Security_Cheat_Sheet.html)
- ASVS 対応: V2.2, V11.7
