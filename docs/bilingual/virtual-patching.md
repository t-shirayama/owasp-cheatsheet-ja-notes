...
<div className="docHero" data-category="asvs-v15">
  <h1>Virtual Patching Cheat Sheet</h1>
  <p className="docSubtitle">仮想パッチチートシート</p>
...
- 公式ページ: [Virtual Patching Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Virtual_Patching_Cheat_Sheet.html)
- ASVS 対応: V15.2
