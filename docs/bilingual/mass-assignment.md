...
<div className="docHero" data-category="asvs-v15">
  <h1>Mass Assignment Cheat Sheet</h1>
  <p className="docSubtitle">Mass Assignment チートシート</p>
...
- 公式ページ: [Mass Assignment Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Mass_Assignment_Cheat_Sheet.html)
- ASVS 対応: V15.3
