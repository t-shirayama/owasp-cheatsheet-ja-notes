...
<div className="docHero" data-category="asvs-v15">
  <h1>Vulnerable Dependency Management Cheat Sheet</h1>
  <p className="docSubtitle">脆弱な依存関係管理チートシート</p>
...
- 公式ページ: [Vulnerable Dependency Management Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.html)
- ASVS 対応: V15.2
