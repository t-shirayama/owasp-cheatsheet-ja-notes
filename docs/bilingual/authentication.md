...
<div className="docHero" data-category="authentication">
  ...
  <p className="docSubtitle">認証チートシート</p>
...
<div className="tabbedContent">
  ...
  <input className="tabInput" type="radio" name="authentication-view" id="authentication-summary" />
  <input className="tabInput" type="radio" name="authentication-view" id="authentication-checklist" />
...
<section id="authentication-summary-panel" className="tabPanel summaryPanel contentPanel">
...
<section id="authentication-checklist-panel" className="tabPanel checklistPanel contentPanel">
