...
<div className="tabbedContent">
  ...
  <div className="contentTabs">
    <label htmlFor="session-management-original">原本</label>
    <label htmlFor="session-management-translation">翻訳</label>
    <label htmlFor="session-management-summary">要点</label>
    <label htmlFor="session-management-checklist">チェックリスト</label>
    <label htmlFor="session-management-bilingual">対比表示</label>
  </div>
