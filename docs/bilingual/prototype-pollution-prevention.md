...
<div className="docHero" data-category="asvs-v15">
  <h1>Prototype Pollution Prevention Cheat Sheet</h1>
  <p className="docSubtitle">Prototype Pollution 防止チートシート</p>
...
- 公式ページ: [Prototype Pollution Prevention Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Prototype_Pollution_Prevention_Cheat_Sheet.html)
- ASVS 対応: V15.3
