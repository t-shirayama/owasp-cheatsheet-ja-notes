...
<div className="docHero" data-category="asvs-v15">
  <h1>Transaction Authorization Cheat Sheet</h1>
  <p className="docSubtitle">トランザクション認可チートシート</p>
...
- 公式ページ: [Transaction Authorization Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Transaction_Authorization_Cheat_Sheet.html)
- ASVS 対応: V6.5, V8.3, V15.4
