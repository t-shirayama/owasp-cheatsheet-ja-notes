...
<p className="docLead">セキュアコードレビューチートシートを、原文・翻訳・対比表示で確認できます。ASVS Index 対応の文脈で、公式原文と日本語訳を確認しやすく整理しています。</p>

<div className="tabbedContent">
  <input className="tabInput" type="radio" name="secure-code-review-view" id="secure-code-review-original" />
  <input className="tabInput" type="radio" name="secure-code-review-view" id="secure-code-review-translation" defaultChecked />
  <input className="tabInput" type="radio" name="secure-code-review-view" id="secure-code-review-bilingual" />

  <div className="contentTabs">
    <label htmlFor="secure-code-review-original" title="OWASP 原文">原文</label>
    <label htmlFor="secure-code-review-translation" title="日本語訳">翻訳</label>
