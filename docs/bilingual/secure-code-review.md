...
<div className="docHero" data-category="asvs-v15">
  <h1>Secure Code Review Cheat Sheet</h1>
  <p className="docSubtitle">セキュアコードレビューチートシート</p>
...
- 公式ページ: [Secure Code Review Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Secure_Code_Review_Cheat_Sheet.html)
- ASVS 対応: V15.4
