...
<p className="docLead">OS コマンドインジェクション防御チートシートを、原文・翻訳・要点・チェックリスト・対比表示で確認できます。ASVS Index 対応の文脈で、理解と実装確認を進めやすく整理しています。</p>
...
<div className="tabbedContent">
  ...
  <div className="contentTabs">
    <label htmlFor="os-command-injection-defense-original" title="OWASP 原文">原本</label>
    <label htmlFor="os-command-injection-defense-translation" title="日本語訳">翻訳</label>
    <label htmlFor="os-command-injection-defense-summary" title="短くまとめた内容">要点</label>
    <label htmlFor="os-command-injection-defense-checklist" title="実装確認用">チェックリスト</label>
