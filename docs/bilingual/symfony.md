...
<div className="docHero" data-category="asvs-v13">
  <h1>Symfony Cheat Sheet</h1>
  <p className="docSubtitle">Symfony チートシート</p>
...
- 公式ページ: [Symfony Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Symfony_Cheat_Sheet.html)
- ASVS 対応: V13.4
