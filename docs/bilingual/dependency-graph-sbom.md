...
<section id="dependency-graph-sbom-bilingual-panel" className="tabPanel bilingualPanel contentPanel">

<div className="bilingualPair">
<div className="englishBlock">
<span className="bilingualLabel english">English (原文)</span>

# Dependency Graph & SBOM Best Practices Cheat Sheet

</div>
<div className="japaneseBlock">
<span className="bilingualLabel japanese">Japanese (翻訳)</span>
