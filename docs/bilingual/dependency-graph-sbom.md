...
<div className="docHero" data-category="asvs-v15">
  <h1>Dependency Graph and SBOM Cheat Sheet</h1>
  <p className="docSubtitle">Dependency Graph and SBOM チートシート</p>
...
- 公式ページ: [Dependency Graph and SBOM Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Dependency_Graph_SBOM_Cheat_Sheet.html)
- ASVS 対応: V15.1
