...
<div className="docHero" data-category="asvs-v13">
  <h1>NPM Security Cheat Sheet</h1>
  <p className="docSubtitle">NPM セキュリティチートシート</p>
...
- 公式ページ: [NPM Security Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/NPM_Security_Cheat_Sheet.html)
- ASVS 対応: V13.4
