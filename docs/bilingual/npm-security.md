...
<div className="docHero" data-category="asvs-v15">
  ...
  <div className="docMeta">
    ...
    <span className="docPill">カテゴリ: 依存関係とサプライチェーン</span>
  </div>
</div>

<p className="docLead">NPM Security Cheat Sheet を、原文・翻訳・対比表示で確認できます。npm パッケージの依存関係、公開、トークン、レジストリ、サプライチェーン攻撃への対策を整理しています。</p>
