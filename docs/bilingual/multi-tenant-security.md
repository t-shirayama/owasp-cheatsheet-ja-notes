...
<div className="tabbedContent">
  ...
  <input className="tabInput" type="radio" name="multi-tenant-security-view" id="multi-tenant-security-translation" defaultChecked />
  <input className="tabInput" type="radio" name="multi-tenant-security-view" id="multi-tenant-security-bilingual" />

  <div className="contentTabs">
    <label htmlFor="multi-tenant-security-original" title="OWASP 原文">原文</label>
    <label htmlFor="multi-tenant-security-translation" title="日本語訳">翻訳</label>
    <label htmlFor="multi-tenant-security-bilingual" title="原文と翻訳を並べて確認">対比表示</label>
  </div>
