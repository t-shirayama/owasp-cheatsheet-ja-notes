...
<div className="docHero" data-category="asvs-v13">
  <h1>GraphQL Cheat Sheet</h1>
  <p className="docSubtitle">GraphQL チートシート</p>
...
- 公式ページ: [GraphQL Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/GraphQL_Cheat_Sheet.html)
- ASVS 対応: V4.3, V13.4
