...
<div className="docHero" data-category="asvs-v13">
  <h1>Docker Security Cheat Sheet</h1>
  <p className="docSubtitle">Docker セキュリティチートシート</p>
...
- 公式ページ: [Docker Security Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html)
- ASVS 対応: V13.2
