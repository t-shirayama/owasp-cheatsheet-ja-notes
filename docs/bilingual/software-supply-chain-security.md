...
<div className="docHero" data-category="asvs-v15">
  <h1>ソフトウェアサプライチェーンセキュリティチートシート</h1>
...
<p className="docLead">ソフトウェアサプライチェーンセキュリティチートシートを、原文・翻訳・対比表示で確認できます。ASVS Index 対応の文脈で、公式原文と日本語訳を確認しやすく整理しています。</p>

<div className="tabbedContent">
  <input className="tabInput" type="radio" name="software-supply-chain-security-view" id="software-supply-chain-security-original" />
  <input className="tabInput" type="radio" name="software-supply-chain-security-view" id="software-supply-chain-security-translation" defaultChecked />
  <input className="tabInput" type="radio" name="software-supply-chain-security-view" id="software-supply-chain-security-bilingual" />

  <div className="contentTabs">
    <label htmlFor="software-supply-chain-security-original" title="OWASP 原文">原文</label>
    <label htmlFor="software-supply-chain-security-translation" title="日本語訳">翻訳</label>
    <label htmlFor="software-supply-chain-security-bilingual" title="原文と翻訳を並べて確認">対比表示</label>
  </div>

<section id="software-supply-chain-security-original-panel" className="tabPanel originalPanel contentPanel">
...
<section id="software-supply-chain-security-translation-panel" className="tabPanel translationPanel contentPanel">
...
<section id="software-supply-chain-security-bilingual-panel" className="tabPanel bilingualPanel">
