...
<div className="docHero" data-category="asvs-v1">
  <h1>XML External Entity Prevention Cheat Sheet</h1>
  <p className="docSubtitle">XXE 防止チートシート</p>
...
- 公式ページ: [XML External Entity Prevention Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html)
- ASVS 対応: V1.2, V1.3, V1.5
