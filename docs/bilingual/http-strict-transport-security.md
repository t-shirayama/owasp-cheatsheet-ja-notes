...
<div className="docHero" data-category="asvs-v3">
  <h1>HTTP Strict Transport Security Cheat Sheet</h1>
  <p className="docSubtitle">HTTP Strict Transport Security チートシート</p>
  <div className="docMeta">
    <span className="docPill">最終更新: 2026-05-20</span>
    <span className="docPill">読了時間: 準備中</span>
    <span className="docPill">カテゴリ: Web Frontend Security</span>
  </div>
</div>
...
- 公式ページ: [HTTP Strict Transport Security Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/HTTP_Strict_Transport_Security_Cheat_Sheet.html)
- ASVS 対応: V3.1, V3.4, V3.7
