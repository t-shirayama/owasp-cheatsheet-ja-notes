...
<div className="docHero" data-category="asvs-v1">
  <h1>Injection Prevention Cheat Sheet in Java</h1>
  <p className="docSubtitle">Java におけるインジェクション防止チートシート</p>
...
- 公式ページ: [Injection Prevention Cheat Sheet in Java](https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_in_Java_Cheat_Sheet.html)
- ASVS 対応: V1.3
