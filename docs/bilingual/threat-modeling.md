...
<div className="docHero" data-category="asvs-v15">
  <h1>Threat Modeling Cheat Sheet</h1>
  <p className="docSubtitle">脅威モデリングチートシート</p>
...
- 公式ページ: [Threat Modeling Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html)
- ASVS 対応: V15.1
