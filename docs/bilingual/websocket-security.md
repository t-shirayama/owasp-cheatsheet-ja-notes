...
<div className="docHero" data-category="asvs-v4">
  <h1>WebSocket Security Cheat Sheet</h1>
  <p className="docSubtitle">WebSocket セキュリティチートシート</p>
...
- 公式ページ: [WebSocket Security Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/WebSocket_Security_Cheat_Sheet.html)
- ASVS 対応: V4.4
