...
<div className="docHero" data-category="asvs-v5">
  ...
  <p className="docSubtitle">ファイルアップロードチートシート</p>
...
- 公式ページ: [File Upload Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html)
- ASVS 対応: V1.2, V5.1, V5.2, V5.4
