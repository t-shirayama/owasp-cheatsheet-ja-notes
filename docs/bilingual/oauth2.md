...
<div className="tabbedContent">
  ...
  <div className="contentTabs">
    <label htmlFor="oauth2-original" title="OWASP 原文">原本</label>
    <label htmlFor="oauth2-translation" title="日本語訳">翻訳</label>
    <label htmlFor="oauth2-summary" title="短くまとめた内容">要点</label>
    <label htmlFor="oauth2-checklist" title="実装確認用">チェックリスト</label>
    <label htmlFor="oauth2-bilingual" title="原文と翻訳を並べて確認">対比表示</label>
  </div>

<section id="oauth2-original-panel" className="tabPanel originalPanel contentPanel">
