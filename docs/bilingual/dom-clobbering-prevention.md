...
<p className="docLead">DOM Clobbering Prevention Cheat Sheet を、原文・翻訳・対比表示で確認できます。ASVS Index 対応の文脈で、公式原文と日本語訳を確認しやすく整理しています。</p>
...
<section id="dom-clobbering-prevention-bilingual-panel" className="tabPanel bilingualPanel contentPanel">
