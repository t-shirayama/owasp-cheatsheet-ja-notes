...
<div className="docHero" data-category="asvs-v1">
  <h1>XML Security Cheat Sheet</h1>
  <p className="docSubtitle">XML セキュリティチートシート</p>
...
- 公式ページ: [XML Security Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html)
- ASVS 対応: V1.2, V1.5
