...
- 公式ページ: [Security Terminology Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Security_Terminology_Cheat_Sheet.html)
- ASVS 対応: V1.1, V6.1, V8.1, V11.1, V15.1
