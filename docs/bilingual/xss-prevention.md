...
<div className="docHero" data-category="asvs-v1">
  <h1>Cross Site Scripting Prevention Cheat Sheet</h1>
  <p className="docSubtitle">XSS 防止チートシート</p>
...
- 公式ページ: [Cross Site Scripting Prevention Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html)
- ASVS 対応: V1.1, V1.2, V1.3
