...
<div className="docHero" data-category="asvs-v13">
  <h1>Django Security Cheat Sheet</h1>
  <p className="docSubtitle">Django セキュリティチートシート</p>
...
- 公式ページ: [Django Security Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Django_Security_Cheat_Sheet.html)
- ASVS 対応: V13.4
