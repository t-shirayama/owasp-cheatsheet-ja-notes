...
- ASVS V3 に関連する Cheat Sheet の翻訳と公開用英日対訳ページを確認する。
...
| --- | --- | --- | --- |
| V3.1 | Content Security Policy Cheat Sheet | [翻訳](../translations/content-security-policy.md) | 作成済み |
...
| V3.2 | DOM Clobbering Prevention Cheat Sheet | [翻訳](../translations/dom-clobbering-prevention.md) | 作成済み |
| V3, V14 | HTML5 Security Cheat Sheet | [翻訳](../translations/html5-security.md) | 作成済み |
| V3, V12 | HTTP Strict Transport Security Cheat Sheet | [翻訳](../translations/http-strict-transport-security.md) | 作成済み |
| V3, V15 | Third Party Javascript Management Cheat Sheet | [翻訳](../translations/third-party-javascript-management.md) | 作成済み |
