...
API、HTTP メッセージ、GraphQL、WebSocket、Web Service に関する章です。
...
- REST Assessment Cheat Sheet
  - 翻訳: [REST評価チートシート 日本語訳](../translations/rest-assessment.md)
  - 要約: [REST評価チートシート 要約](../summaries/rest-assessment.md)
  - チェックリスト: [REST評価チートシート 開発チェックリスト](../checklists/rest-assessment.md)
...
- ASVS V4 に関連する Cheat Sheet の翻訳、要約、開発チェックリストを確認する。
...
| V4.1 | REST Assessment Cheat Sheet | [翻訳](../translations/rest-assessment.md) / [要約](../summaries/rest-assessment.md) / [チェックリスト](../checklists/rest-assessment.md) | 作成済み |
| V4.1 General API and Web Service Security; V4.2 RESTful Web Service; V4.3 GraphQL; V4.4 WebSocket; V9.2 Token and Session-Based Authentication | REST Security Cheat Sheet | [翻訳](../translations/rest-security.md) / [要約](../summaries/rest-security.md) / [チェックリスト](../checklists/rest-security.md) | 詳細化済み |
